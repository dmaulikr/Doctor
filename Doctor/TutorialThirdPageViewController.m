//
//  TutorialThirdPageViewController.m
//  Doctor
//
...
#import "TutorialThirdPageViewController.h"

@interface TutorialThirdPageViewController (){
    int i;
}
...
@implementation TutorialThirdPageViewController
...
- (void) clicked{
    ...
    switch (i) {
        case 1:
            ...
            break;
        case 2:
            [self performSegueWithIdentifier:@"goToFourthTutorialSegue" sender:self];
            break;
        case 3:
            break;
        default:
